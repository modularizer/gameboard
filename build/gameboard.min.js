// src/js/gameboard.js?v20230827T18:19:32.210Z
...
var CustomScene = class extends THREE.Scene {
  ...
  checkZones() {
    ...
    /* @__PURE__ */ console.log("inZones", inZones);
...
var BaseModel = class extends THREE3.Group {
  ...
  shuffleXYZ(config) {
    ...
    for (let yi = yimin; yi < yimax; yi += 1) {
      ...
      if (y < box.min.y + padding || y > box.max.y - padding) {
        continue;
      }
      yPositions.push(y);
    }
    for (let zi = zimin; zi < zimax; zi += 1) {
      ...
      if (z < box.min.z + padding || z > box.max.z - padding) {
        continue;
      }
      zPositions.push(z);
    }
...
var Model = class extends BaseModel {
  constructor({ src, color, name, position, rotation, moveable, metadata, covered, hidden, shellColor, dropzone, movezone, opacity }) {
    ...
    if (!covered)
      this.loadPromise.then(() => this.uncover());
    if (color !== void 0)
      this.setColor(color);
    if (opacity !== void 0)
      this.setOpacity(opacity);
...
// src/js/utils/chat.js?v20230827T18:19:32.210Z
...
// src/js/index.js
window.version = "v20230827T18:19:32.210Z";
